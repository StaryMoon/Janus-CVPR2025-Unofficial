...
<p align="center">
  <img src="assets/paper-preview.png" alt="Janus-CVPR2025-Unofficial paper or project page preview" width="900">
</p>
...
| Focus | This repository organizes a PyTorch implementation for Janus: Decoupling Visual Encoding for Unified Multimodal Understanding and Generation, focusing on decoupled visual encodi... |
...
This repository organizes a PyTorch implementation for **Janus: Decoupling Visual Encoding for Unified Multimodal Understanding and Generation**, focusing on decoupled visual encoding for multimodal understanding and generation. The codebase is structured like a standard research repository so that model components, configuration files, scripts, and evaluation utilities can be extended independently.
...
```python
import torch
from janus_cvpr2025_unofficial import ModelConfig, UnofficialModel, reconstruction_loss

config = ModelConfig(task="multimodal", hidden_dim=128, num_layers=2, num_heads=4)
...
```python
import torch
from janus_cvpr2025_unofficial import UnofficialModel
...
|---|---|---|
| Main quantitative comparison | Main paper tables, pp. 12966-12977 | [CVF paper page](https://openaccess.thecvf.com/content/CVPR2025/html/Wu_Janus_Decoupling_Visual_Encoding_for_Unified_Multimodal_Understanding_and_Generation_CVPR_2025_paper.html) |
| Ablation study | Ablation / experiment section | [CVF paper page](https://openaccess.thecvf.com/content/CVPR2025/html/Wu_Janus_Decoupling_Visual_Encoding_for_Unified_Multimodal_Understanding_and_Generation_CVPR_2025_paper.html) |
| Qualitative examples | Main paper figures and supplemental material | [CVF paper page](https://openaccess.thecvf.com/content/CVPR2025/html/Wu_Janus_Decoupling_Visual_Encoding_for_Unified_Multimodal_Understanding_and_Generation_CVPR_2025_paper.html) |
...
- Thanks to the authors of **Janus: Decoupling Visual Encoding for Unified Multimodal Understanding and Generation** for the original research.
...
cvpr-2025, pytorch, unofficial-implementation, multimodal-learning, image-generation, vision-language
